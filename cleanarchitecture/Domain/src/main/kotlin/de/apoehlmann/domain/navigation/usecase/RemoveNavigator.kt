...
class RemoveNavigator(val appNavigationRepository: AppNavigationRepository, val navigator: Navigator): UseCase<Void>() {

    override fun getScheduler() = Schedulers.trampoline()

    override fun buildObservable() = appNavigationRepository.removeNavigator(navigator)
